...
public class CategoriaController extends Controller {
    ...
    public Result telaEditar(Long id) {
        ...
        try {
            ...
            Form<CategoriaFormData> formData = form(CategoriaFormData.class).fill(categoriaFormData);
    ...
    public Result inserir() {
        ...
        Form<CategoriaFormData> formData = form(CategoriaFormData.class).bindFromRequest();
