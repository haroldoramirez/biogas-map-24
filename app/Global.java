...
public class Global extends GlobalSettings {
    ...
    public F.Promise<Result> onHandlerNotFound(Http.RequestHeader request) {
        return F.Promise.pure(notFound(views.html.mensagens.erro.naoEncontrada.render(request.uri())));
    }
    ...
    public F.Promise<Result> onBadRequest(Http.RequestHeader request, String error) {
        return F.Promise.pure(badRequest(views.html.error.render(error)));
    }
